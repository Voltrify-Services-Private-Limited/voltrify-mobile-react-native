...
const DeviceCondition = ({ route }) => {
    ...
    useEffect(() => {
        getdeviceCondition();
        Alert.alert(JSON.stringify(condition));
    ...
    const getdeviceCondition = async () => {
        try {
            ...
            setCondition(JSON.stringify(resData.data.conditions));
        } catch (err) {
    ...
    return (
        <View style={styles.mainView}>
            <View style={styles.topHeader}>
                ...
                <Text style={styles.headerText}>Device {condition.condition}</Text>
            </View>
            <View style={{ padding: 10 }}>
                <Text style={styles.lableText}>Select Device Condition</Text>
                <Dropdown
